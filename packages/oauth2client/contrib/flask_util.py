...
.. code-block:: python
    ...
    modules.config['SECRET_KEY'] = 'your-secret-key'

    modules.config['GOOGLE_OAUTH2_CLIENT_SECRETS_FILE'] = 'client_secrets.json'

    # or, specify the client id and secret separately
    modules.config['GOOGLE_OAUTH2_CLIENT_ID'] = 'your-client-id'
    modules.config['GOOGLE_OAUTH2_CLIENT_SECRET'] = 'your-client-secret'

    oauth2 = UserOAuth2(modules)
...
.. code-block:: python
   :emphasize-lines: 3,7,10
    ...
    # Note that modules.route should be the outermost decorator.
    @modules.route('/needs_credentials')
    @oauth2.required
    def example():
...
sure to add ``http[s]://[your-modules-url]/oauth2callback`` as an authorized
callback url.
...
.. code-block:: python
    ...
    oauth2 = UserOAuth2(modules, include_granted_scopes=True)
...
class UserOAuth2(object):
    ...
    If modules is specified, all arguments will be passed along to init_app.

    If no modules is specified, then you should call init_app in your application
    ...
    def init_app(self, app, scopes=None, client_secrets_file=None,
                 ...
                 storage=None, **kwargs):
        """Initialize this extension for the given modules.
    ...
    def _load_config(self, client_secrets_file, client_id, client_secret):
        ...
        Priority:
            ...
            2. Config passed via the GOOGLE_OAUTH2_CLIENT_SECRETS_FILE modules
               config.
            3. Config passed via the GOOGLE_OAUTH2_CLIENT_ID and
               GOOGLE_OAUTH2_CLIENT_SECRET modules config.
        ...
        try:
            ...
            raise ValueError(
                ...
                'the modules configuration variables '
